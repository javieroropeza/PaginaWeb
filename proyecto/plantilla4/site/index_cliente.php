	...
	<div id="page_2">
		<div class="main">
			...
			<header>
				...
				<nav>
					<ul class="menu">
						<li class="active"><a href="#page_2">Ver Pedido</a></li>
					...
					<div align='center'> 
						<table border='1' cellpadding='0' cellspacing='0' width='700' bgcolor='#F6F6F6' bordercolor='#FFFFFF'> 
							...
							<?php
								...
								session_start();	
									$_SESSION['id'];								
									$sql = ("select * from producto_pedido where id_usuario = '$_SESSION[id]; '");
	...
	<div id="page_3">
		<div class="main">
			...
			<header>
				...
				<nav>
					<ul class="menu">
						<li><a href="#page_2">Ver Pedido</a></li>
...
<div class="extra">
	<div id="page_1">
		<div class="main">
			...
			<label style = "color:blue;"  align='center'>CLIENTE</label>
				<nav>
					<ul id="menu">
						<li class="nav1"><a href="#page_2">Ver Pedido</a></li>
			...
			<section class="content">
				...
				<form action="Pedido.php" method="post">	
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este es el terminado que tienenlas piezas de yeso.</p>						
					</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Base tacel de flor $80.</p>
												<input class="button" type="checkbox" name="producto2" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product2"><br>
					</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<input class="button" type="checkbox" name="producto3" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product3"><br>					
										</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Juego de jarron de eces $120.</p>
												<input class="button" type="checkbox" name="producto4" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product4"><br>
					</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<input class="button" type="checkbox" name="producto5" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product5"><br>					
										</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<input class="button" type="checkbox" name="producto6" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product6"><br>					
										</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<input class="button" type="checkbox" name="producto7" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product7"><br>
					</div>
        		</article>
				<article class="col1 pad_left1">									
					<div class="wrapper pad_top1 pad_bot2">
					...
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto9" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product9"><br>
					</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto10" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product10"><br>
					</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
						<input class="button" type="checkbox" name="producto11" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product11"><br>					
										</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto12" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product12"><br>
					</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto13" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product13"><br>
					</div>
        		</article>
				<article class="col1">		
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto14" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product14"><br>
					</div>					
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto15" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product15"><br>
					</div>			
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto16" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product16"><br>
					</div>
					<div class="wrapper pad_top1 pad_bot2">
						...
						<p class="pad_bot3">Este producto se encuentra en todas las conbinaciones de colores.</p>
												<input class="button" type="checkbox" name="producto17" value="1">Comprar <br>
						<label>Cantidad</label>
						<input type="text" style="width:50px;height:18px;background-color:cornsilk;color:peru;font-size:12pt;font-family: 
										Comic Sans MS;text-align:center;border-color:burlywood;border-style:double;border-width:medium " name="product17"><br>																			

					</div>					
						<input type="submit"  class="button button-block"  value="Hacer Pedido"  name="registra"/></input>
					</form>	
				</article>
			</section>
			<!--content end-->
