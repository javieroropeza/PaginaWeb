		...
		<link rel="stylesheet" type="text/css" href="formulario.css" media="all" />
			...
			<br></br>
				...
				<label>Nombre</label>
					...
					<div >					
						<input type="radio" name="rcliente" value="1">Cliente<br>
						<input type="radio" name="rcliente" value="2" checked >Usuario Común<br>
					</div>
			...
			?>
					<a class="href" href= "index_usuariocomun.php?regresar">Regresar  (<?php echo $_SESSION['usuario'];?> )</a>
				<?php
				}else
