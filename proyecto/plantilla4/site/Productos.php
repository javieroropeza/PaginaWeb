<html>
	<head>
		<title>Producto Yeso</title>
		<link rel="stylesheet" type="text/css" href="index_style.css"/>
	</head>
			<div class="container">
			<br></br>
				<h1 style = "color:peru;"> Producto Yeso</h1>													
						...
						?>							
												<label style = "color:blue;"  align='RIGTH'>Eliminar Producto</label>  
							<br>
							<?php							
								include "conex.php";							
								...
								$consulta=mysql_query("select * from productos_yeso where nombre_prod_yeso='$nombre' AND material = '$material' ");											
								if(mysql_num_rows($consulta)){
									...
									$consulta= ("DELETE from productos_yeso  WHERE id_producto_yeso = '$id' AND  material= '$material' ");			
					...
					<label style = "color:blue;"  align='RIGTH'>TABLA Productos</label>
							...
							<?php
								...
								session_start();
								@$cuenta="Cliente";
								$sql = ("select * from productos_yeso");
								$result =mysql_query ($sql); 

								while ($registro = mysql_fetch_array($result)){  
									echo " 
										<tr> 
											<td width='150'>".$registro['id_producto_yeso']."</td> 
											<td width='150'>".$registro['id_imagen']."</td> 
											<td width='150'>".$registro['id_pedido']."</td> 
											<td width='150'>".$registro['nombre_prod_yeso']."</td>
											<td width='150'>".$registro['precio_yeso']."</td> 							
